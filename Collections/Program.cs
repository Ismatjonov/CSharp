...
class Program
{
    static void Main(string[] args)
    {
        ...
        // ======== Span<T> ========
        // 1st way
        Span<string> people200 = ["Tom", "Bob", "Sam"];
        
        // 2nd way
        string[] people2001 = { "Tom", "Bob", "Sam" };
        Span<string> people202 = new Span<string>(people2001);
        
        // 3rd way
        Span<string> people203 = people200;
        
        // We can word like arrays
        ...
        Span<int> secondDecade = temperaturesSpan.Slice(20, 10);
